...
endmodule //PROGRAM_RAM_altsyncram
//VALID FILE
...
`endif
	...
	PROGRAM_RAM_altsyncram	PROGRAM_RAM_altsyncram_component (
				.aclr0 (aclr),
				.address_a (address),
				.clock0 (clock),
				.data_a (data),
